...
print_r($_POST);
    ...
    $gift_sup_no = $_POST['gift_sup_no'];
    $gift_description = $_POST['gift_description'];
    //$sup_name = $_POST['sup_name'];
    //$sup_tel = $_POST['sup_tel'];
    

$sql = "INSERT INTO gift(gift,exchange_points,gift_sup_no,gift_description) VALUES ('$gift','$exchange_points','$gift_sup_no','$gift_description')";
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="p-5">
                            <div class="text-center">
                                <h1 class="h4 text-gray-900 mb-4">新增禮品</h1>
                            </div>
                            <form class="user">
