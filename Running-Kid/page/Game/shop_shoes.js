...
export default function Shop_shoes({navigation}) {
    return (
        <SafeAreaView >
                ...
                >
                    <View style={{marginTop:10,flexDirection:'row'}}>
                        ...
                        <View style={styles.textbox_title}>
                            <Text style={styles.title}>鞋子商店</Text>
                        </View>
                    </View>
                    ...
                    <View style= {styles.textbox}>
                        ...
                        <View style={{flex:4,justifyContent:'flex-start',flexDirection:'row'}}>
                            <View style={{width:100,flex:1,borderRadius:20,alignItems:'center',justifyContent:'center'}}>
                                <Image
                                    source={require('../../assets/game_man/shoes1.png')}
                                    style={{width:150,height:140}}></Image>
